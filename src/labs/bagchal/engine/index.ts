...
import { MoveGenerator, PositionEvaluator } from '$labs/bagchal/ai';
import { executeMove } from './rules';
import type { Move as BagchalMove } from '$labs/bagchal/ai/types';
...
export const BagchalEngine: BaseEngine<BagchalMove, GameState> = {
	...
	evaluate(state: GameState): number {
		return PositionEvaluator.evaluatePosition(state, adjacency);
	}
};
