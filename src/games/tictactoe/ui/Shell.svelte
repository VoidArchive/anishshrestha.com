<script lang="ts">
	import { gameState, handleCellClick as applyPlayerMove, resetGame } from '$games/tictactoe/store.svelte';
				...
				<div class="board-well">
					<div class="board-inner">
						<div class="board-wrapper">
							<TicTacToeBoard {gameState} handleCellClick={handleCellClick} />
						</div>
					</div>
				</div>
			</div>
...
<style>
	...
	.board-inner {
		...
		padding: 0.75rem;
		position: relative;
		box-shadow: inset 4px 4px 12px rgba(0, 0, 0, 0.7), inset -2px -2px 8px rgba(255, 255, 255, 0.04), inset 0 0 20px rgba(0, 0, 0, 0.5), inset 0 0 40px rgba(201, 42, 42, 0.02);
	}
